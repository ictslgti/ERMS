...
<body>
    <div class='page-wrapper toggled bg2 border-radius-on light-theme'>
        ...
        <td class="btn-group" role="group" > <a class = "btn btn-warning btn-group-sm" href="insert.php?edit=', $row['exam_id'], '"> Edit </a>
         <a class = "btn btn-danger btn-group-sm" href="?delete=', $row['exam_id'], '"> Delete </a></td>
        </tr>';
                            }
                        } else {
                            echo 'no rows';
