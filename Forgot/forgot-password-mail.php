...
<body>
    ...
    <?php 
         if(isset($_POST['forgot'])){
                ...
                $url = 'http://'.$_SERVER['SERVER_NAME'].'/erms/Forgot/forgot-password.php?id='.$id.'&email='.$email;
                $output = ' <!DOCTYPE html>
                                <html lang="en">
    ...
    <div class="container">
        ...
        <div class="login-content">
            <form method="post" name="emailconfo" onsubmit="return validateForm()">
                <h2 class="title">Reset Your Password</h2>
                <p class=" text-center mb-4 blockquote-footer">Forgot with gmail</p>
            ...
            function validateForm() {
                var x = document.forms["emailconfo"]["email"].value;
                if (x == "" || x == null) {
                    Swal.fire(
                        'Plesee Enter your email! ',
                        '',
                        'warning'
                    )
                    return false;
