                                        ...
                                        <div class="card border-left-info shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div
                                                            class="text-xs font-weight-bold text-info text-uppercase mb-2">
                                                            Attendance</div>
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col-auto">
                                                                <div
                                            ...
                                            <div
                                                ...
                                                <div class="dropdown no-arrow">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                        ...
                                                        <a class="nav-link waves-light" data-toggle="tab"
                                                            href="#panel1002" role="tab">Construction</a>
                                                        <a class="nav-link waves-light" data-toggle="tab"
                                                            href="#panel1003" role="tab">Auto mobile</a>
                                                        <a class="nav-link waves-light" data-toggle="tab"
                                                            href="#panel1004" role="tab">Electronic</a>
                                                        <a class="nav-link waves-light" data-toggle="tab"
                                                            href="#panel1005" role="tab">Mechanical</a>
                                                        <a class="nav-link waves-light" data-toggle="tab"
                                                            href="#panel1006" role="tab">Foot</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-xl-3 col-lg-4">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="classic-tabs">
                                                    <div class="tab-content rounded-bottom">
                                                        <div class="tab-pane fade in show active" id="1001"
                                                            role="tabpanel">
                                                        ...
                                                        <div class="tab-pane fade in show active" id="1002"
                                                            role="tabpanel">
                                                        ...
                                                        <div class="tab-pane fade in show active" id="1003"
                                                            role="tabpanel">
                                                        ...
                                                        <div class="tab-pane fade in show active" id="1004"
                                                            role="tabpanel">
                                                        ...
                                                        <div class="tab-pane fade in show active" id="1005"
                                                            role="tabpanel">
                                                        ...
                                                        <div class="tab-pane fade in show active" id="1006"
                                                            role="tabpanel">
